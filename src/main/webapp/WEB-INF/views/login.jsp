	...
	<div class="container-fluid fixed-top">
		...
		<div class="container px-0">
			<nav class="navbar navbar-light bg-white navbar-expand-xl">
				<a href="index.html" class="navbar-brand"><h1 class="text-primary">Morning Empire</h1></a>
				...
				<div class="collapse navbar-collapse bg-white" id="navbarCollapse">
					...
					<div class="d-flex m-3 me-0">
						...
						</a> <a href="/login" class="my-auto"> <i
					...
					<div class="loginContainer"
						...
						<div class="left-container">
							...
							<form:form id="register-form" action="/register" method="POST"
								...
								<form:input type="password" id="register-password"
									path="password" />
								<br />
